...
foreach ($lista_array_ss as $v) {
	...
	//PENAL / BONUS
	//$str_tempo_total = '<div style="color:red"><b>'.substr($v['penalidade'],0,8)."</b></div>";
	//$str_tempo_total .='<div style="color:blue"><br>'.substr($v['bonus'],0,8);
...
foreach ($lista_array_geral as $v) {
	...
	//TEMPO	BRUTO
	//array_push($lista_geral[$i], '<b>'.substr($v['total'],0,10)."</b>");
...
array_push($campos_header_ss,'TEMPO<div style="color:blue ; font-size:20px"><br>Dif. Lider</div>');
// ESPECIAL ESPECIAL ESPECIAL ESPECIAL ESPECIAL ESPECIAL ESPECIAL ESPECIAL ESPECIAL ESPECIAL ESPECIAL
...
array_push($campos_header_geral,'TOTAL<div style="color:blue ; font-size:20px"><br>Dif. Lider</div>');
...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body marginheight="0" marginwidth="0" leftmargin="0" topmargin="0" bgcolor="#000000">
		<? echo printHeader(
					"RESULTADOS DA ETAPA E ACUMULADOS",
		...
		<table border="0" cellpadding="5" cellspacing="0" bgcolor="#ffffff" align="center" valign="top" width="100%">
			<tr valign="top">
				<td>
					<span class="td1"> <div style="font-size:22px"><? echo geraTxtPag("", $_REQUEST["trechos"], $numero_trecho) ?>  </span>
				...
				<td>
					<span class="td1"> <div style="font-size:22px"> ACUMULADO AT&Eacute; A <? echo geraTxtPag("", $_REQUEST["trechos"], $numero_trecho) ?>  </span>
					<table cellpadding="5" cellspacing="0" class="tb1">
						<?
