...
foreach ($lista_array as $v) {
	...
	//PENAIS - BONUS
	$str_penais_bonus = '<div style="color:red; font-size:20px">'.substr($v['penalidade'],0,$length_str)."</div>";
	$str_penais_bonus .= '<div style="color:blue; font-size:20px"><br>'.substr($v['bonus'],0,$length_str)."</div>";
	...
	$str_tempo_total .='<div style="font-size:20px"><br>'.substr($v['diferenca_lider'],0,$length_str);
...
array_push($campos_header_ss,'TOTAL<div style="font-size:20px"><br>Dif. Lider</div>');
