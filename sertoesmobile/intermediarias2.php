...
foreach ($lista_array_ss as $v) {
	...
	if ($_REQUEST["intermediarias"]>=1) array_push($lista_ss[$i], '<b>'.substr($v['tempo1'],0,$length_str)."</b>");
	
	//TEMPO	INTERMEDIARIA 2
	if ($_REQUEST["intermediarias"]>=2) array_push($lista_ss[$i], '<b>'.substr($v['tempo2'],0,$length_str)."</b>");
	
	//TEMPO	INTERMEDIARIA 3
	if ($_REQUEST["intermediarias"]>=3) array_push($lista_ss[$i], '<b>'.substr($v['tempo3'],0,$length_str)."</b>");
	
	//TEMPO	INTERMEDIARIA 4
	if ($_REQUEST["intermediarias"]>=4) array_push($lista_ss[$i], '<b>'.substr($v['tempo4'],0,$length_str)."</b>");
