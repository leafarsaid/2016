...
function printHeader($txt_pag, $txt_timestamp, $iFIM) {
	...
	$header .= sprintf("%s\n","     <img src=\"imagens/sertoes2016.jpg\"width=80 border=0 valign=\"center\" align=\"absmiddle\"/>");
	$header .= sprintf("%s\n","    </td>");
	...
	$header .= sprintf("%s\n","     <img src=\"imagens/patro3_sertoes_2016.jpg\" width=500 border=0 align=\"absmiddle\"/>&nbsp;");
...
function geraFooter($iCat, $iMod, $strMod) {
	...
	$footer .= sprintf("%s\n"," </td><td align=\"right\">");	$footer .= ($_REQUEST['db']=='1' || $_REQUEST['db']=='local1') ? 					sprintf("%s   ","<img src=\"imagens/ass_dunas_cba_chrono.png\" width=330 border=0 align=\"absmiddle\"/>") : 					sprintf("%s   ","<img src=\"imagens/ass_dunas_cbm_chrono.png\" width=330 border=0 align=\"absmiddle\"/>");	$footer .= sprintf("%s\n","</td></tr></table>");	return $footer;
}	
